...
install: show-os install-common-dot-files install-common-dot-directories install-common-config-directories install-os-specific

clean: show-os clean-common-dot-files clean-common-dot-directories clean-common-config-directories
...
install-common-config-directories:
	@echo "(all) Installing Dot Directories"	
	@SOURCE_DIR=${PWD}/all/config TARGET_DIR=${HOME}/.config FILE_LEADER="." sh bin/link_all_files.sh
	@echo "(all) Installing Dot Directories Done!"
...
clean-common-config-directories:
	@echo "(all) Cleaning Dot Directories"
	@SOURCE_DIR=${PWD}/all/config TARGET_DIR=${HOME}/.config FILE_LEADER="." sh bin/remove_linked_files.sh
	@echo "(all) Cleaning Dot Directories Done!"
